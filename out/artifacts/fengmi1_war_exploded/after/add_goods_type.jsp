<%@page import="com.xiaobai.entity.GoodsType"%>
<%@page import="com.xiaobai.service.impl.GoodsTypeServiceImpl"%>
<%@page import="com.xiaobai.service.GoodsTypeService"%>
<%@page import="com.xiaobai.entity.User"%>
<%@page import="com.xiaobai.service.impl.UserServiceImpl"%>
<%@page import="com.xiaobai.service.UserService"%>
